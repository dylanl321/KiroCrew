...
def _build_launcher_script(
    ...
    *,
    ...
    uid = os.getuid()
    gid = os.getgid()
    # Connect fence (issue 9806) build-time inputs. HARD RULE: this builder
    ...
    # Loopback denial is unconditional in the verdict, so the #9806 core
...
# import-free and relies on these bindings.
